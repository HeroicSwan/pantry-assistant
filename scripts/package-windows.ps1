...
try {
  ...
  $items = @(".next", "public", "src", "scripts", "drizzle", "docs\27-self-hosted-windows-installation.md", "package.json", "pnpm-lock.yaml", "pnpm-workspace.yaml", "tsconfig.json", "next.config.ts", ".env.example", "README.md")
