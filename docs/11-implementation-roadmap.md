...
Live Twilio delivery, public webhook verification, OpenAI provider calls, Vercel/Windows scheduler registration, production credentials, backup/restore rehearsal, and external accessibility/performance audits require target-environment configuration. They are documented, not silently treated as complete.
